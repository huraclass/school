...
import com.example.schoolspring.exception.RequestException;
...
public class FileListController {
    ...
    private ModelAndView bdSelectOneCall(@ModelAttribute("fileListVO") FileListVO fileListVO, String bdSeq, HttpServletRequest request) {
        ModelAndView mav = new ModelAndView();
        ...
        log.info("boardListDomain"+boardListDomain);
